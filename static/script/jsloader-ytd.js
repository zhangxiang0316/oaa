...
OPEN_WIN_PROXY = false;
	...
	JSLoader.loadStyleSheet(CONTEXT_PATH+"css/ytd-min.css");
	...
	JSLoader.loadJavaScript(CONTEXT_PATH+"script/configuration-ytd.js");
	JSLoader.loadJavaScript(CONTEXT_PATH+"script/ytd.min.js");
